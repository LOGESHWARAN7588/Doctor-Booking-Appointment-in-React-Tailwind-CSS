  ...
  return (
    <div className="flex justify-between items-center h-24 max-w-[1250px] mx-auto px-4 text-white bg-transparent">
      ...
      <ul className="hidden md:flex ">
        ...
        <button className="gap-34 bg-[#23A6F0] w-[200px] rounded-md font-medium my-6 mx-auto py-3 text-white">
          Get Quote Now
        </button>
      </ul>
      ...
      <ul
        className={
          nav
            ? "fixed left-0 top-0 w-[60%] h-full border-r border-r-gray-900 bg-[#F6F6F6] ease-in-out duration-500"
            : "ease-in-out duration-500 fixed left-[-100%]"
        }
      >
        <h1 className="w-full text-3xl font-bold text-[#252B42] m-4">
          Physionic
        </h1>
