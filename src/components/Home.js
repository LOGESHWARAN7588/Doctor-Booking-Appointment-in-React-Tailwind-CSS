...
<button class="hover:border-slate-400 border-white border w-[200px] rounded-full font-medium my-6 mx-auto py-3 text-white" variant="outlined">Learn More</button>
...
<div className='text-left font-medium text-[#737373]  '>
          <h3 className='py-2 font-bold text-[#252B42] mx-8 text-lg text-center'>Book Appointment</h3>
              ...
              <form>
                ...
                Name*
                <br></br>
                <input type="text" class="border border-white rounded-lg py-2 px-4 text-gray-700" name="inputName" placeholder="Full Name"></input>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="absolute right-0 top-0 mt-2 mr-2 h-4 w-4 text-gray-600 pointer-events-none">
      <path fill-rule="evenodd" d="M11.95 6.95a.5.5 0 01.7.7l-3.823 3.822a.5.5 0 01-.637.057l-.088-.057-3.822-3.823a.5.5 0 01.638-.765l.088.057L8 9.586l3.537-3.536a.5.5 0 01.708 0z" clip-rule="evenodd"></path>
              ...
              <button className=' bg-[#23A6F0] w-[250px] rounded-lg font-medium my-3 mx-auto py-1  justify-center   text-white  '>Book Appointment</button>
